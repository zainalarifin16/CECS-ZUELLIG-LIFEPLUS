	...
	ContentLayout.prototype = {
		render: function(parentObj) {
			try {
				...
				// Get blog image
				content.imageAdURL = contentClient.getRenditionURL({
					'itemGUID': (content.data.blog_image_ad instanceof Object) ? content.data.blog_image_ad.id : content.data.blog_image_ad,
